//
// Created by Caesar on 2025/12/14.
//

#ifndef KHTTPD_FRAMEWORK_CRONCPP_HPP
#define KHTTPD_FRAMEWORK_CRONCPP_HPP
#include <vector>
#include <string>
#include <sstream>
#include <bitset>
...
#define  CRONCPP_CONSTEXPTR
  ...
  template <typename Traits = cron_standard_traits>
  static std::chrono::system_clock::time_point cron_next(cronexpr const& cex,
...
#endif //KHTTPD_FRAMEWORK_CRONCPP_HPP
